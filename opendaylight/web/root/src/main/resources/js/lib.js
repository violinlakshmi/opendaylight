define(
    ...
    function(one) {
      ...
      one.lib.dashlet = {
        ...
        datagrid : {
          /*
           * The init function returns HTML markup for the datagrid per the
           * options provided. Each consumer of the datagrid must first call
           * init and then provide the datasource for the grid. id: this is the
           * id of the table options: { searchable: true/false, pagination:
           * turned off for now, flexibleRowsPerPage: turned off } classes :
           * String containing bootstrap related classes. For ex: "table-striped
           * table-condensed" The classes "table", "table-bordered" and
           * "datagrid" will be added by default
           */
      ...
      one.lib.form = {
        ...
        select : {
          create : function(options, multiple, sort) {
            ...
            // If specified, sort the option elements based on their text
            // field
      ...
      one.lib.helper = {
        parseInt : function(value) {
          return (value != null && value.trim() !== '') ? parseInt(value) : ''
        },
        parseFloat : function(value) {
          return (value != null && value.trim() !== '') ? parseFloat(value) : ''
        }
      }
