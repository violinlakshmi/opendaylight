        ...
        one.topology.graph = new $jit.MultiTopology(
            {
              ...
              Events : {
                ...
                onMouseEnter : function(node, eventInfo, e) {
                  ...
                  } else if (eventInfo.edge != undefined && eventInfo.edge.nodeTo.data["$type"] == "switch"
                ...
                onTouchMove : function(node, eventInfo, e) {
                  $jit.util.event.stop(e); // stop default
                  // touchmove
                  // event
              ...
              onCreateLabel : function(domElement, node) {
                var nameContainer = document.createElement('span'), closeButton = document.createElement('span'), style = nameContainer.style;
