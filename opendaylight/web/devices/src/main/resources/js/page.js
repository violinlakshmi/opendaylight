...
require([ 'datasource', 'devices/nodeslearnt', 'devices/staticroute', 'devices/subnetgateway', 'devices/spanport', 'devices/connection', 'underscore', 'fuelux/loader.min'], 
    function(StaticDataSource, nodeslearnt, staticRouteConfig, subnetGatewayConfig, spanPortConfig, connection) {
      one.f = {};
