define(['datasource'], function(StaticDataSource) {
    ...
    one.f.switchmanager.spanPortConfig.ajax.main(url, {}, function(content) {
      ...
      if (content.privilege === 'WRITE') {
        ...
        $button.click(function() {
          ...
          var checkedCheckBoxes = $("#" + one.f.switchmanager.spanPortConfig.id.dashlet.datagrid)
        ...
        dataSource : dataSource
          ...
          function() {
            $("#" + one.f.switchmanager.spanPortConfig.id.dashlet.selectAll).click(
                function() {
                  $("#" + one.f.switchmanager.spanPortConfig.id.dashlet.datagrid).find(':checkbox')
                      .prop(
                          'checked',
  ...
  modal : {
    ...
    save : function($modal) {
      var result = {};
      result['nodeId'] = $('#' + one.f.switchmanager.spanPortConfig.id.modal.form.nodes, $modal)
          .val();
      result['spanPort'] = $('#' + one.f.switchmanager.spanPortConfig.id.modal.form.port, $modal)
          .val();
    ...
    removeMultiple : {
      dialog : function(spanPortsToDelete) {
        ...
        $('#' + one.f.switchmanager.spanPortConfig.id.modal.remove, $modal).click(this,
            function(e) {
              var requestData = {};
              var spanPorts = [];
